...
from deeprl_hw2.constants import model_file
...
def main():  # noqa: D103
    ...
    parser.add_argument('--model', default='frozenlake', type=str, help='Type of model')
    ...
    env = 'Deterministic-4x4-FrozenLake-v0'
    ...
    if args.dir:
        ...
        model_dir = os.path.join(args.output, args.dir, model)
    ...
    if args.phase == 'train':
        ...
        dqnAgent.policy = GreedyEpsilonPolicy(epsilon, num_actions)
        dqnAgent.capture_episode_video(env)
